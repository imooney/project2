...
int main() {
    ...
    //test of copy constructor & assignment operator
    cout << "~~~testing copy constructor & assignment operator~~~\n";
    vecNd *copytest = new vecNd(*test_f);
    cout << "copy of f is: "; copytest->Print();
    ...
    //+=:
    plusequals_test(test_vec); //test that it didn't change the argument vecNd: test_vec[4].Print();
...
void plus_test(vecNd* test_vec) {
    ...
    vecNd add12 = test_vec[1] + test_vec[2];
    vecNd add34 = test_vec[3] + test_vec[4];
    vecNd add56 = test_vec[5] + test_vec[6];
    cout << "a + b = "; add12.Print(); cout << '\n';
    cout << "c + d = "; add34.Print(); cout << '\n';
    cout << "e + f = "; add56.Print(); cout << '\n';
}
